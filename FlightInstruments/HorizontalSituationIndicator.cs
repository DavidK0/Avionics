...
namespace Avionics {
    ...
    float additionalAngle = 0f) {
            float angle = additionalAngle - headingRad + (float)Math.PI / 2f;
        ...
        internal static unsafe void Render(ImDrawList* draw_list, float2 windowPos, float2 size) {
            ...
            ImDrawListExtensions.AddText(draw_list, cdi_center - new float2(cdi_radius, -cdi_radius), new ImColor8(255, 255, 255, 255), $"BRG:{BRG_text}");
            ImDrawListExtensions.AddText(draw_list, cdi_center - new float2(70 - cdi_radius, 20 + cdi_radius), new ImColor8(255, 255, 255, 255), $"DST:{DST_text}");
            ...
            ImDrawListExtensions.AddCircle(draw_list, LocalToWorld(left_dot1_local, runway_heading), dot_radius, white, 0);
            ImDrawListExtensions.AddCircle(draw_list, LocalToWorld(left_dot2_local, runway_heading), dot_radius, white, 0);
            ImDrawListExtensions.AddCircle(draw_list, LocalToWorld(right_dot1_local, runway_heading), dot_radius, white, 0);
            ImDrawListExtensions.AddCircle(draw_list, LocalToWorld(right_dot2_local, runway_heading), dot_radius, white, 0);
            ...
            for(int i = 0; i < 3; i++) {
                ...
                float2 lateral_needle_p1 = LocalToWorld(lateral_needle_p1_local, runway_heading);
                float2 lateral_needle_p2 = LocalToWorld(lateral_needle_p2_local, runway_heading);
            ...
            float2 alignment_needle_1_p1 = LocalToWorld(alignment_needle_p2_local, runway_heading);
            float2 alignment_needle_1_p2 = LocalToWorld(alignment_needle_p1_local, runway_heading);
            float2 alignment_needle_2_p1 = LocalToWorld(alignment_needle_p4_local, runway_heading);
            float2 alignment_needle_2_p2 = LocalToWorld(alignment_needle_p3_local, runway_heading);
            ...
            float2 arrowhead_p1 = LocalToWorld(arrowhead_p1_local, runway_heading);
            float2 arrowhead_p2 = LocalToWorld(arrowhead_p2_local, runway_heading);
            float2 arrowhead_p3 = LocalToWorld(arrowhead_p3_local, runway_heading);
            ...
            float2 bearing_marker_p1 = LocalToWorld(bearing_marker_p1_local, nav_bearing);
            float2 bearing_marker_p2 = LocalToWorld(bearing_marker_p2_local, nav_bearing);
            float2 bearing_marker_p3 = LocalToWorld(bearing_marker_p3_local, nav_bearing);
            float2 bearing_marker_p4 = LocalToWorld(bearing_marker_p4_local, nav_bearing);
            float2 bearing_marker_p5 = LocalToWorld(bearing_marker_p5_local, nav_bearing);
