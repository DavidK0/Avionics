...
* Turn Indicator
* Radar Altimeter
* Autopilot with altitude hold, heading hold, and airport navigation
...
4. Enable autopilot in the 'Autopilot' window and set the target altitude. You must disable the manual mode on the in game autopilot.
